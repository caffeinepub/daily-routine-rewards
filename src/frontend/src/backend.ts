...
export class Backend implements backendInterface {
    ...
    async addTask(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getTodayCompletions(arg0: string): Promise<Array<Completion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodayCompletions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uncompleteTask(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uncompleteTask(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
